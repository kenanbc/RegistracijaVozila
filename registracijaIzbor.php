      ...
      <body>
        ...
        <div class="container vh-100 d-flex flex-column justify-content-center">
            <div class="row mb-3">
              ...
              <div class="col-2">
                <button class="btn" onclick="location.href='./index.php'" style="padding: 0;">
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">Registracija novog vozila</h4>
                        </div>
                        <div class="card-body">
                        ...
                        <button type="button" class="w-100 btn btn-lg btn-primary" style="margin-top: 17px;" onclick="location.href='registracija.php'">Registracija vozila</button>
                      </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">Produži registraciju</h4>
                        </div>
                        <div class="card-body">
                        ...
                        <button type="button" class="w-100 btn btn-lg btn-primary" onclick="location.href='produziRegistraciju.php'">Produži registraciju</button>
                      </div>
                    </div>
                </div>
            </div>
