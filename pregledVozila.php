...
<html>
      ...
      ?>
        <div class="container d-flex justify-content-center align-items-center">
            <div class="col">
                <div class="card my-4 rounded-3 shadow-sm vh-90">
                  <div class="card-header py-3 text-center d-flex justify-content-between align-items-center">
                    ...
                    <h4 class="my-0 mx-auto">Pregled vozila</h4>
                  </div>
                        ...
                        <table class="table table-striped text-center">
                                    ...
                                    if ($result->num_rows > 0) {
                                        while($row = $result->fetch_assoc()) {
                                          echo '
                                                <tr>
                                                <th scope="row">
                                                <form action="obradaVozila.php" method="post">
                                                    <input type="hidden" name="voziloID" value="'.$row["VoziloID"].'">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $sql = "SELECT v.VlasnikID, v.ime, v.prezime, v.jmbg, v.adresa, v.grad, v.kanton, v.telefon
                                            ...
                                            where v.VlasnikID = r.VlasnikID AND r.VoziloID =  '$modalniID'";
                          ...
                          <table class="table table-striped text-center mb-1">
                                ...
                                <?php 
                                    ...
                                    $sql = "SELECT v.VoziloID, v.Marka, v.Model, v.karoserija, v.GodinaProizvodnje, v.BrojSasije, r.registracijskaOznaka
                                            FROM vozilo as v, registracija as r
                                            WHERE v.VoziloID = r.VoziloID AND v.VoziloID = $modalniID";
                                    $result = $conn->query($sql);
                                ...
                                <?php 
                                    ...
                                    $sql = "SELECT datumRegistracije, datumIstekaRegistracije, statusRegistracije
                                            FROM registracija WHERE voziloID = $modalniID";
                                    $result = $conn->query($sql);
            ...
            <script>
              $(document).ready(function() {
                ...
                document.querySelectorAll('tbody tr').forEach(function(row) {
                    var tablica = row.querySelector('th:nth-child(2)');
                    if (tablica) {
          ...
          input.addEventListener('keydown', function(event) {
              ...
              if (key === 'Backspace') {
                  if ((value.length === 4 && value.charAt(3) === '-') || (value.length === 7 && value.charAt(6) === '-')) {
    ...
    $(document).ready(function() {
            ...
            <?php if(isset($_SESSION['voziloID'])) { ?>
                openModal();
            <?php } ?>
        });
